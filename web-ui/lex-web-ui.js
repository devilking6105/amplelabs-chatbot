...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  initMessageList: function initMessageList(context) {
    context.state.config.lex.initialText.forEach(function(message) {
    ...
    context.dispatch('pushMessage', {
      ...
      responseCard: {
        ...
        genericAttachments: [{
          ...
          buttons: [
            {text: "A free meal", value: "A free meal"},
            {text: "A place to sleep", value: "A place to sleep"},
            {text: "A place to shower", value: "A place to shower"},
          ],
          imageUrl: null,
          subTitle: null,
          title: null
